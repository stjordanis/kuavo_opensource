...
namespace HighlyDynamic
{
    ...
    public:
        ...
        bool armCoMIK(Eigen::VectorXd &arm_quat_xyz, Eigen::VectorXd &all_q);
        bool armCoMIKContinues(Eigen::VectorXd &arm_quat_xyz, Eigen::VectorXd &all_q);
    ...
    protected:
        ...
        double time_{0};
        RobotState_t state_des_, state_des_st, state_est_st, prev_state_des_, prev_state_des_st_, state_des_4cons, state_des_ik_;
